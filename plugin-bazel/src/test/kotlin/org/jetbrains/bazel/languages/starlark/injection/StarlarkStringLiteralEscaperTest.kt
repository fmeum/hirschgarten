...
class StarlarkStringLiteralEscaperTest : StarlarkPsiTestCase() {
  ...
  fun `should decode escape sequences`() {
    ...
    decode("\"\\x41\\101\\u0042\\U00000043\"") shouldBe "AABC"
  ...
  fun `should escape new content`() {
    StarlarkStringLiteralManipulator.escape("a\"b\\c\nd", StarlarkQuote.DOUBLE) shouldBe "a\\\"b\\\\c\\nd"
    StarlarkStringLiteralManipulator.escape("a'b\"c", StarlarkQuote.SINGLE) shouldBe "a\\'b\"c"
    StarlarkStringLiteralManipulator.escape("a\"b\nc", StarlarkQuote.TRIPLE_DOUBLE) shouldBe "a\"b\nc"
    StarlarkStringLiteralManipulator.escape("a\"\"\"b", StarlarkQuote.TRIPLE_DOUBLE) shouldBe "a\\\"\"\"b"
    StarlarkStringLiteralManipulator.escape("ab\"", StarlarkQuote.TRIPLE_DOUBLE) shouldBe "ab\\\""
  }
